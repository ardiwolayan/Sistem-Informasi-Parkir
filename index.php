...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img height="526" width="274" src="asset/img/1.png" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img height="526" width="274" src="asset/img/2.png" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img height="526" width="274" src="asset/img/3.png" class="d-block w-100" alt="...">
    </div>
  </div>
