	...
	<main role="main" class="flex-shrink0">
 		<div class="container">
 			<div class="row justify-content-center mt-5">
 				<div class="col-md-4">
 					<div class="card-header bg-transparent mb-0"><h5 class="text-center">Edit Data <span class="font-weight-bold text-primary"> Mobil Keluar</span></h5></div> 
 					<div class="card">
 						<div class="card-body">
 							<form method="post" action="updatemk.php">
							  <div class="form-group">
							    ...
							    <input type="text" class="form-control" name="tanggalkeluar" value="<?php echo $d['tanggalkeluar']; ?>" id="tanggalkeluar">

							    <label for="waktukeluar">Waktu Keluar</label>
							    <input type="text" class="form-control" name="waktukeluar" value="<?php echo $d['waktukeluar']; ?>" id="waktukeluar">




							  <button type="submit" class="btn btn-primary" name="submit">Ganti</button>
							<a type="text" href="mobilkeluar.php" class="btn btn-white" name="kembali">Kembali</a>
