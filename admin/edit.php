	...
	<main role="main" class="flex-shrink0">
 		<div class="container">
 			<div class="row justify-content-center mt-5">
 				<div class="col-md-4">
 					<div class="card-header bg-transparent mb-0"><h5 class="text-center">Edit <span class="font-weight-bold text-primary">Data Petugas</span></h5></div> 
 					<div class="card">
 						<div class="card-body">
							<?php
							...
							while($d = mysqli_fetch_array($data)){
 							...
 							<form method="post" action="update.php">
							  ...
							  <div class="form-group">
								...
								<option value='Pintu Masuk' <?= $d['role']=='Pintu Masuk'?"selected":null ?>>Pintu Masuk</option>
								<option value='Pintu Keluar'<?= $d['role']=='Pintu Keluar'?"selected":null ?>>Pintu Keluar</option>
								<option value='Petugas Parkir'<?= $d['role']=='Petugas Parkir'?"selected":null ?>>Petugas Parkir</option>
								<option value='Admin' <?= $d['role']=='Admin'?"selected":null ?>>Admin</option>
								<option value='Manajemen'<?= $d['role']=='Manajemen'?"selected":null ?>>Manajemen</option>
							    </select>
							  </div>
