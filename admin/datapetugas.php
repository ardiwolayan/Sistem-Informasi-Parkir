 ...
 --> 						</div>
		...
		while($d = mysqli_fetch_array($data)){
			...
			<tr>
				...
				<td>
					<a  href="edit.php?id=<?php echo $d['id']; ?>" ><center>Edit</a></center>
					<a href="hapus.php?id=<?php echo $d['id']; ?>" ><center>Hapus</a></center>
				</td>
			</tr>
			<?php 
		}
		?>
 							...
 							<a type="botton" class="btn btn-primary" href="daftar.php" style="float: left;" href="daftar.php"> Tambah Petugas </a>
