 				...
 				<div class="col-12">
 					<div class="card">
 						<div class="card-header">
 							<h1 class="text-center">Mobil Keluar</h1>
<!--  							<a class='btn btn-primary center-block' href="home.php"> Kembali </a>
 ...
 --><!-- <button type='button' class='btn btn-primary center-block'> Klik Disini</button>--> 						</div>
		...
		$no = 1;
		$data = mysqli_query($koneksi,"select * from datamobil where tanggalkeluar!='' && waktukeluar!='' ");
		while($d = mysqli_fetch_array($data)){
			...
			<tr>
				...
				<td class="text-center"><?php echo $d['waktukeluar']; ?></td>
				<td>
					<a href="editmk.php?id=<?php echo $d['id']; ?>"><center>Edit</center></a>
					<a href="hapusmk.php?id=<?php echo $d['id']; ?>"><center>Hapus</center></a>
				</td>
			</tr>
			<?php 
		}
