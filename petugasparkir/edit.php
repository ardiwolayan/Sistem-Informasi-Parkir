	...
	<main role="main" class="flex-shrink0">
 		<div class="container">
 			<div class="row justify-content-center mt-5">
 				<div class="col-md-4">
 					<div class="card-header bg-transparent mb-0"><h5 class="text-center">Edit <span class="font-weight-bold text-primary">Data</span></h5></div> 
 					<div class="card">
 						<div class="card-body">
						...
						while($d = mysqli_fetch_array($data)){
							...
							<a type="button" href="home.php" class="btn btn-white" name="kembali">Kembali</a>
