 ...
 <body>
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="laporan.php">Laporan Pendapatan</a>
      </li>
...
<!--           <a class="dropdown-item" href="mobilmasuk.php">Tambah Mobil</a> -->
...
<!-- End Navbar -->
 	...
 	<main role="main" class="flex-shrink0">
 		<div class="container">
 			<h1>Halo, Manajemen <?= $_SESSION['username']?>! </h1>
